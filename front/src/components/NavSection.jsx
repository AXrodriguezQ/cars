...
const NavSection = () => {
  return (
    <div className='container space-y-4 flex-column sm:flex justify-between items-center md:p-2 my-4'>
        <h2 className=' text-xl font-bold'>Nuestros coches</h2>
        <input className='border-slate-200 border-2 p-2 w-64 sm:w-96 rounded-3xl px-4' type="search" name="" id="" placeholder='busca tu coche aqui...' />
