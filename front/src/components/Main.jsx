...
const Main = () => {
  return (
    <main className='p-4 md:px-20 sm:px-4 mt-8 md:flex justify-between items-center'>
        <div className='md:w-1/2 space-y-8'>
            <h1 className='font-bold text-6xl sm:text-7xl'>exclusivos, rentables y son tus preferidos!</h1>
